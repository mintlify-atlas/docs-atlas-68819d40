---
title: "Durable AI Agents: Combining Temporal with OpenAI Agents SDK"
sidebarTitle: "Durable Agents"
description: "Learn why production AI agents need Temporal, how OpenAIAgentsPlugin wires the two together, and what you gain without touching your agent code."
---
...
<CardGroup cols={2}>
  <Card title="Automatic retries" icon="rotate" href="/exercises/durable-agent">
  ...
  <Card title="Crash recovery" icon="shield-halved" href="/exercises/durable-agent">
  ...
  <Card title="Full execution history" icon="list-check" href="/exercises/durable-agent">
  ...
  <Card title="OpenAI trace correlation" icon="link" href="/exercises/agent-routing">
