...
│   ├── 01_agent_hello_world/     # Exercise 1 (.ipynb)
│   ├── 02_temporal_hello_world/  # Exercise 2 (.ipynb)
│   ├── 03_durable_agent/         # Exercise 3 (.ipynb)
│   └── 04_agent_routing/         # Exercise 4 (.py files)
├── exercises/                    # Homework starter code
│   ├── 01_agent_hello_world/     # Exercise 1 starter (.ipynb)
│   ├── 02_temporal_hello_world/  # Exercise 2 starter (.ipynb)
│   ├── 03_durable_agent/         # Exercise 3 starter (.ipynb)
