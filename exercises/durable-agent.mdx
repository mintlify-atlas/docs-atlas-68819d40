---
title: "Build a Crash-Proof AI Agent with Temporal and OpenAI"
sidebarTitle: "Durable Agent"
description: "Add OpenAIAgentsPlugin to a Temporal workflow so every LLM call is a retryable activity—crash-proof durability without rewriting agent logic."
---
...
<CardGroup cols={2}>
  <Card title="OpenAIAgentsPlugin" icon="plug" href="/concepts/durable-ai-agents">
  ...
  <Card title="State Persistence" icon="database" href="/concepts/durable-ai-agents">
    Crash the worker mid-execution and restart it—the workflow resumes from the exact activity that was in-progress.
  </Card>
  <Card title="Trace Correlation" icon="magnifying-glass" href="/concepts/durable-ai-agents">
