---
title: "Temporal Hello World: Your First Workflow and Activity"
sidebarTitle: "Temporal Hello World"
description: "Wrap a weather API call in a Temporal activity, orchestrate it from a workflow, and watch execution history and automatic retries live in the Temporal UI."
---
...
<CardGroup cols={2}>
  <Card title="Workflow Timeline" icon="timeline" href="/concepts/temporal-fundamentals">
  ...
  <Card title="Activity Detail" icon="magnifying-glass" href="/concepts/temporal-fundamentals">
  ...
  <Card title="Execution History" icon="list" href="/concepts/temporal-fundamentals">
  ...
  <Card title="Worker Polling" icon="satellite-dish" href="/concepts/temporal-fundamentals">
