---
title: "Multi-Agent Routing Workflow with Language Specialists"
sidebarTitle: "Agent Routing"
description: "Build a triage-and-handoff multi-agent system in production file structure: a triage agent detects language and routes to French, Spanish, or English specialist agents inside a durable Temporal workflow."
---
